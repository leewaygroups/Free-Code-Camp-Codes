...
var NgIf = React.createClass({displayName: "NgIf",
  propTypes: {
...
var TwitchHeader = React.createClass({displayName: "TwitchHeader",
  render: function () {
    return (
      React.createElement("div", {className: "row"}, 
          React.createElement("div", {className: "col-md-6"}, 
            React.createElement("h3", null, "Twitch TV Live")
          ), 
          React.createElement("div", {className: "col-md-2 pull-right"}, 
              React.createElement("ul", {className: "pull-right"}, 
                    ...
                    React.createElement("li", null, "On-line"), 
                    React.createElement("li", null, "Off-line")
              )
          )
      )
    );
...
var TwitchList = React.createClass({displayName: "TwitchList",
  createTwitchList: function(twitch){
      return (
        React.createElement("div", {className: "twictch-item", key: twitch._id}, 
           React.createElement("div", {className: "col-xs-2"}, 
             React.createElement("img", {src: twitch.image, className: "img-responsive img-twitch-channel", alt: "Responsive image"})
           ), 
           React.createElement("div", {className: "col-xs-8 text-center"}, 
              React.createElement("h3", {className: "twitch-channel-caption"}, React.createElement("small", null, React.createElement("a", {href: "#"}, twitch.name)))
           ), 
           React.createElement("div", {className: "col-xs-2"}, 
              React.createElement(NgIf, {show: twitch.online}, 
                  React.createElement("h5", {className: "badge twictch-badge twictch-online"}, React.createElement("a", {href: twitch.stream.channel.url, target: "_blank"}, "online"))
              ), 
              React.createElement(NgIf, {show: twitch.offline}, 
                  React.createElement("h5", {className: "badge twictch-badge twictch-offline"}, "offline")
              )
           )
        )
      );
...
},{"../common/reangular":2,"react":163}],5:[function(require,module,exports){
 'use strict';
...
var Twitch = React.createClass({displayName: "Twitch",
  ...
  render: function(){
    return (
      React.createElement("div", {className: " container-fluid col-md-12"}, 
          React.createElement("div", {className: "well col-md-8 col-md-offset-2"}, 
          React.createElement("div", {className: "row row-header"}, 
              React.createElement(TwitchHeader, null)
          ), 
          React.createElement("div", {className: "row row-body"}, 
             React.createElement(TwitchList, {twiches: this.state.twitches})
          ), 
          React.createElement("div", {className: "row row-footer"}, 
              React.createElement("p", null, "Streams")
          )
          )
      )
    );
...
},{"../api/getter":1,"./twitchHeader-react":3,"./twitchList-react":4,"react":163}],6:[function(require,module,exports){
'use strict';

var React = require('react');
var Twitch = require('./components/twitchMain-react.js');


React.render(React.createElement(Twitch, null), document.getElementById('app'));

},{"./components/twitchMain-react.js":5,"react":163}],7:[function(require,module,exports){
